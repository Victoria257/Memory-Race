...
export const ActionPanel = () => {
  ...
  return (
    <div 
      id="action-panel"
      className={`w-full h-full bg-[#F1F8E9] text-gray-800 p-6 transition-all duration-500 rounded-none tablet-p:rounded-3xl shadow-xl border-0 tablet-p:border-4 border-[#7DA33C]/20 ${isActionPhase ? 'opacity-100' : 'opacity-50 grayscale pointer-events-none'} flex flex-col justify-center`}>
