...
export const JoinGame = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-auto p-4 tablet-p:p-6 bg-[#F1F8E9] rounded-[2.5rem] shadow-2xl border-8 border-[#7DA33C]/20 flex flex-col max-h-full tablet-p:max-h-[85vh] overflow-y-auto">
